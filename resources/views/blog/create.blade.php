...
<div class="w-4/5 m-auto pt-20">
    {{-- multipart/form-data para informar a aplicação que vamos upar um arquivo --}}
    <form action="/blog" method="POST" enctype="multipart/form-data">
        ...
        <textarea name="description" placeholder="Description..." class="py-20 bg-transparent block border-b-2 w-full h-60 text-l outline-none"></textarea>
